    ...
    function Asteroids() {
        ...
        if (typeof G_vmlCanvasManager != 'undefined') {
            ...
            if (!this.canvas.getContext) {
                alert("So... you are using IE?  Sorry but at the moment DESTROY only supports Firefox");
            }
        } else {
            if (!this.canvas.getContext) {
        ...
        if (!document.getElementById('ASTEROIDS-NAVIGATION')) {
            ...
            this.points.style.font = "28pt Century Gothic, sans-serif";
